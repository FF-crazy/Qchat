...
from backend.models.openai import OpenAIMessageBlock, OpenAIMessageRequest, OpenAIUsage


class ContextManager(BaseModel):
    context: list[OpenAIMessageBlock]
    usage: OpenAIUsage | None = None
    MAX_TOKEN: int

    def add_message(self, message: OpenAIMessageBlock) -> None:
